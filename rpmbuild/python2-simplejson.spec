...
Summary:        Simple, fast, extensible JSON encoder/decoder for Python 2
...
%{python2_sitearch}/simplejson-%{version}-py%{python2_version}.egg-info



%changelog
* Wed May 22 2024 Lolizeppelin <lolizeppelin@gmail.com> - 3.19.2-3
- Update For fedora 40 with python2
